  ...
  return [
    {
      ...
      title: "Move one BZ point across the drawn edge",
      brief: "The cyan point is k. It leaves the square at the right and re-enters at the left; its white Bloch image keeps moving.",
      objective: "Cross the periodic seam and touch 4 source relays",
      hint: "Move the cyan BZ point with WASD or arrows. Watch the white point on the right answer every move.",
      start: { u: 0.86, v: 0.2 },
      ordered: true,
      timeLimit: null,
      targetCharge: null,
    ...
    },
    {
      ...
      title: "Cross the amber line and watch the image turn back",
      brief: "At the amber line λ̄ reaches zero. Beyond it, the same small BZ patch contributes with the opposite orientation.",
      objective: "Visit a + cell, a − cell, then a + cell",
      hint: "Nothing damages you on the line. Watch the white point fold and the live cell contribution change sign.",
      start: { u: 0.6, v: 0.08 },
      ordered: true,
      timeLimit: null,
      targetCharge: 1,
    ...
    },
    {
      ...
      number: "03",
      eyebrow: "PROVENANCE",
      title: "Make three cyan points land on one white point",
      brief: "The south-pole Bloch state is reached from three different BZ positions. The right-hand location alone does not reveal its source.",
      objective: "Touch all 3 BZ preimages of one Bloch point",
      hint: "Press Space to reveal source bearings. Their packet signs are +, +, −; their λ̄ magnitudes are different.",
      start: { u: 0.82, v: 0.48 },
      ordered: false,
      timeLimit: null,
      targetCharge: 1,
    ...
    },
    {
      ...
      title: "Add five packet signs and get one",
      brief: "These gates are authored samples, not BZ integration cells. They isolate the cancellation rule: +1−1+1−1+1.",
      objective: "Collect 5 packets whose signed sum is +1",
      hint: "Follow the numbered locks. The bottom meter is a packet receipt, not the paper's continuous integral.",
      start: { u: 0.82, v: 0.48 },
      ordered: true,
      timeLimit: 70,
      targetCharge: 1,
    ...
    },
    {
      id: "free",
      number: "05",
      eyebrow: "SIGNED PACKET PROXY",
      title: "Make the packet proxy equal +1, then return home",
      brief: "Choose a route through five authored relays. Their sign algebra mirrors the BZ integral, but the relays are not a quadrature grid.",
      objective: "Collect all packets, close the path, finish at signed sum +1",
      hint: "Any order works. The actual Chern number is the full-BZ integral shown in SPEC; this mission only rehearses its cancellation.",
      start: { u: 0.5, v: 0.08 },
